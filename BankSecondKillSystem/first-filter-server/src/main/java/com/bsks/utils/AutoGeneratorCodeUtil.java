...
public class AutoGeneratorCodeUtil {
    public static void main(String[] args) {
        ...
        String url = "jdbc:mysql://118.31.33.202:3311/decision-engine-schema?useSSL=false&useUnicode=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai";
        String driverName = "com.mysql.cj.jdbc.Driver";
        String username = "root";
        String password = "12345";
        String tableName = "first_filter_record";
